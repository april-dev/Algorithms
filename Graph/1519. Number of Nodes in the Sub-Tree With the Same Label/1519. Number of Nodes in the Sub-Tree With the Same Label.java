//Since it is a tree, we can avoid duplicate visiting by checking if its neighbor is its parent; Therefore, the following code is simplified by removal of set seen.
