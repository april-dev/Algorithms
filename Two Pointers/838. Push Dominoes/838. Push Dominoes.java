public String pushDominoes(String dominoes) {
        ...
        for (int j=1; j<dominoes.length(); j++){
            ...
            if (dominoes.charAt(i)==dominoes.charAt(j)){
                for (int k=0; k<middle; k++) sb.append(dominoes.charAt(i));
            }else if (dominoes.charAt(i)=='L' && dominoes.charAt(j)=='R'){
                for (int k=0; k<middle; k++) sb.append('.');
            }else{
                for (int k=0; k<middle/2; k++) sb.append('R');
                if (middle%2==1) sb.append('.');
                for (int k=0; k<middle/2; k++) sb.append('L');
            }
            i = j;
        }
        return sb.toString();
